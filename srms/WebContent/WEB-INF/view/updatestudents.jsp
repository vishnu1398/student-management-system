...
<body>
    ...
    <div class="container mt-3">
        <h3 class="text-center text-dark">Update Student !</h3>
        <hr>
    </div>  
    <div class="container mt-5">
        <form action="saveRecord" method="POST">
        	<div class="form-group row m-2">
              ...
              <div class="col-sm-10">
                <input type="text" name="id" class="form-control" id="inputEmail3" placeholder="Student Id" value="${studentObj.id}">
              </div>
            </div>
            <div class="form-group row m-2">
              <label for="inputEmail3" class="col-sm-2 col-form-label">Student Name</label>
              <div class="col-sm-10">
                <input type="text" name="name" class="form-control" id="inputEmail3" placeholder="Student Name" value="${studentObj.name}">
              </div>
            </div>
            <div class="form-group row m-2">
              <label for="inputPassword3" class="col-sm-2 col-form-label">Age</label>
              <div class="col-sm-10">
                <input type="number" name="age" class="form-control" id="inputPassword3" placeholder="Age" value="${studentObj.age}">
              </div>
            </div>
